        ...
        try:
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": self._get_system_prompt(request.query_type)
                    },
                    {
                        "role": "user", 
                        "content": prompt
...
Your role is to analyze underwriting requests and provide clear, well-reasoned decisions based on the provided evidence and guidelines.
"""
...
""")
    ...
    def _mock_response(self, request: LLMRequest) -> LLMResponse:
        ...
        return LLMResponse(
            ...
            required_questions=["Please provide additional documentation"] if decision == "REFER" else [],
